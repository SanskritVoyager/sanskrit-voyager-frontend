      ...
      >
        {text !== '' || bookTitle !== null ? (
          <Grid.Col
            ...
            style={{
              height: isMobile && isWordInfoVisible ? vhActualHalf : vhActual,
              display: 'flex',
          ...
          >
            <div 
              className={`${classes.readingContainer} ${
                isWordInfoVisible && !isMobile ? classes.readingContainerSplit : ''
              }`}
            >
              <div
            ...
            <>
              {isMobile && isWordInfoHalf ? (
                ...
                <Grid.Col
                  ...
                  style={{
                    height: vhActual,
                    opacity: !isWordInfoVisible && isWordInfoHalf ? 0 : 1,
                    visibility: !isWordInfoVisible && isWordInfoHalf ? 'hidden' : 'visible',
                    display: 'flex',
                    flexDirection: 'column',
                    alignItems: 'center',
                    padding: 0,
                ...
                >
                  ...
                  <div className={`${classes.wordInfoContainer} ${
                    isWordInfoHalf ? '' : classes.wordInfoContainerFull
                  }`}>
                    <div className={classes.scrollContainer}>
                      {isLoadingWordData ? (
                        <LoadingSkeleton />
